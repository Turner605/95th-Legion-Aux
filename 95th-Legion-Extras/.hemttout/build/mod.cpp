...
tooltip         = "95th Legion Aux Extras";
tooltipOwned    = "95th Legion Aux Extras";  // Tool tip displayed when the mouse is left over, in the main menu
overview        = "95th Aux Mod Extras";         // Overview text, displayed from the extension menu
description     = "The aux mod for the 95th Legion."; // Probably in context with action
