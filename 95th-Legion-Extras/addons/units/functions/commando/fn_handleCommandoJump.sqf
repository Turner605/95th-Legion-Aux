...
if (!(_unit call AUX_95th_Extras_fnc_checkCanJump)) exitWith {};
if (_unit call AUX_95th_Extras_fnc_checkIsInHouse) exitWith {systemChat "No free space to make a jump";};
