	...
	class CfgWeapons {
		...
		class AUX_95th_Helmet_Squad_One {
			...
			class Player {
				alwaysSelectable = 0;
				labels = "Player";
				values[] = {"Volt","Sand", "Manila", "Osprey", "Chimera", "King", "Lisek", "Mermaid"};
		...
		class AUX_95th_Helmet_Squad_Four {
			...
			class Player {
				alwaysSelectable = 0;
				labels = "Player";
				values[] = {"Bretek", "Third", "Ratler", "York", "Nyet"};
				...
				class Nyet { label = "Nyet"; description = "Nyet's Helmet"; };
			};
		};
		...
		class AUX_95th_Helmet_Squad_Six {
			...
			class Player {
				alwaysSelectable = 0;
				labels = "Player";
				values[] = {"Outcast", "Edge", "Styx", "Neron"};
