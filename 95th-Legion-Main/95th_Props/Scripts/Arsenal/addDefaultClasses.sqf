...
private _riflemanLoadout = [[
	...
	["AUX_95th_Bag_Backpack_Visible_Trooper",_baseBackpack], 
	"95th_Helmet_Trooper", 
...
private _riotLoadout = [[
	...
	["AUX_95th_Bag_Backpack_Visible_Trooper",_baseBackpack + [["JLTS_riot_shield_item",1]]], 
	"95th_Helmet_Trooper", 
	"", ["JLTS_CloneBinocular","","","",["Laserbatteries",1],[],""],
	["ItemMap","ItemGPS","JLTS_clone_comlink","ItemCompass","ItemWatch","95th_P1_Nightvision_Invisible"]
],[]];
...
private _engineerLoadout = [[
	...
	["AUX_95th_Backpack_Visible_Ordnance",_engineerBackpack], 
...
private _medicLoadout = [[
	...
	["AUX_95th_Backpack_Visible_Medic", _medicBackpack], 
	"95th_Helmet_Medic", 
	"", ["JLTS_CloneBinocular","","","",["Laserbatteries",1],[],""],
	["ItemMap","ItemGPS","JLTS_clone_comlink","ItemCompass","ItemWatch","95th_P1_Nightvision_Invisible"]
],[]];
