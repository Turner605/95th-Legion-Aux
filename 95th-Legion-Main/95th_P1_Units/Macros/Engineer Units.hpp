#define NEW_95TH_ENGINEER_UNIT(name,helmet,vest) class 95th_Engineer_Unit_##name## : JLTS_Clone_P2_DC15A {\
    scope = 2;\
	scopecurator=2;\
    author=95th Aux Team;\
	faction=95th_Legion_Faction_Clones;\
	editorSubcategory=95th_Engineer;\
	...
	displayName=[95th] Engineer - ##name##;\
	uniformClass=95th_P1_Uniform_##name##;\
	linkedItems[]={95th_Engineer_Helmet_##helmet##,95th_Basic_Vest_##vest##,ItemMap,JLTS_clone_comlink,ItemCompass,ItemWatch};\
	respawnLinkedItems[]={95th_Engineer_Helmet_##helmet##,95th_Basic_Vest_##vest##,ItemMap,JLTS_clone_comlink,ItemCompass,ItemWatch};\
