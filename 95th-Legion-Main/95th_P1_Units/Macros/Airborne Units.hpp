#define NEW_95TH_AIRBORNE_UNIT(name,helmet,vest) class 95th_Airborne_Unit_##name## : JLTS_Clone_P2_DC15A {\
	...
	linkedItems[]={95th_Airborne_Helmet_##helmet##,95th_Vest_##vest##,ItemMap,JLTS_clone_comlink,ItemCompass,ItemWatch};\
	respawnLinkedItems[]={95th_Airborne_Helmet_##helmet##,95th_Vest_##vest##,ItemMap,JLTS_clone_comlink,ItemCompass,ItemWatch};\
