...
class CfgWeapons {
	...
	class AUX_95th_DP23: arifle_MX_Base_F {
		...
		class Single: Mode_SemiAuto {
			...
			class StandardSound: BaseSoundModeType {
				weaponSoundEffect = "";
				begin1[] = {"\AUX_95th_DP23\Sounds\dp23_fire.wss",1,1,1800};
				soundBegin[] = {"begin1",1};
			};
			reloadTime = 0.3;
			dispersion = 0.00073;
	...
	class AUX_95th_DP23_shield: AUX_95th_DP23 {
		...
		hiddenSelectionsTextures[] = {"AUX_95th_DP23\Data\DP23_co.paa","\MRC\JLTS\weapons\Shield\data\shield_co.paa"};
		handAnim[] = {"OFP2_ManSkeleton","\AUX_95th_DP23\Anims\DP23_shielded_handanim.rtm"};
		inertia = 0.8;
		recoil = "recoil_pdw";
		class WeaponSlotsInfo: WeaponSlotsInfo {
			mass = 110;
