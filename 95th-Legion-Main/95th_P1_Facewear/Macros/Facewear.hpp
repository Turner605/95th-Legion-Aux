...
#define NEW_95th_SCARF_HUD(name) class Facewear_Scarf_HUD_##name##_95th : SWLB_CEE_Clone_Scarf {\
...
#define NEW_95th_PONCHO_HUD(name) class Facewear_Poncho_HUD_##name##_95th : PhoenixCore_Poncho {\
