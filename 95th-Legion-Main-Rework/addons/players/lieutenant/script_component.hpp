#define COMPONENT players_lieutenant
#define COMPONENT_BEAUTIFIED Players_Lieutenant
#define PLAYER_NAME lieutenant
#define PLAYER_NAME_BEAUTIFIED Lieutenant
