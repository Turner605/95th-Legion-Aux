class Player {
    alwaysSelectable = 0;
    labels = "Player";
    values[] = {"Bretek", "Third", "Ratler", "York", "Night", "Kaz", "Gum", "Galvin", "Charlie", "Skylight"};
    class Bretek { label = "Bretek"; description = "Bretek`s"; };
    ...
    class Charlie { label = "Charlie"; description = "Charlie`s"; };
