class Player {
    alwaysSelectable = 0;
    labels = "Player";
    values[] = {"Volt","Sand", "Manila", "Khimera", "Lisek", "Mermaid", "Dracus", "Triage", "Wolf", "Spell", "Forge", "Lucky"};
    ...
    class Khimera { label = "Khimera"; description = "Khimera`s Helmet"; };
    ...
    class Lucky { label = "Lucky"; description = "Lucky`s Helmet"; };
};